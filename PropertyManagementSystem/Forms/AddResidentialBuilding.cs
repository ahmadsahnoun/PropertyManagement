...
{
    public partial class AddResidentialBuilding : Form
    {
        private readonly MyDbContext _db = new MyDbContext();
        public AddResidentialBuilding()
        {
            InitializeComponent();
        }
        ...
        private void Clear()
        {
            txtName.Text = txtBuiltArea.Text =
                txtNotBuiltArea.Text =
                    txtTotalArea.Text = txtAddress.Text = txtLocationUrl.Text = txtNoOfFloors.Text = "";
